...
Try it without installing anything: [the playground](https://guygrigsby.github.io/rikki/) runs the interpreter in your browser (the py bridge needs a real CPython, so that part is native-only).
